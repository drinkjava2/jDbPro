...
public class DbPro extends TemplateQueryRunner implements NormalJdbcTool {
	 ...
	 * operation Exception happen. Note: The caller is responsible for closing
	 * the connection.
	 * 
	 * @param sql
	 * @param params
	 ...
	 * Query for an Object, only return the first row and first column's value
	 * if more than one column or more than 1 rows returned, a null object may
	 * return if no result found , DbRuntimeException may be threw if some SQL
	 * operation Exception happen.
	 * 
	 * @param sql
	 * @param params
	 ...
	 * @return An object generated by the handler.
	 */
	public <T> T nInsertBatch(ResultSetHandler<T> rsh, String sql, Object[][] params) {
		try {
	 ...
	 * DbRuntimeException may be threw if some SQL operation Exception happen.
	 * 
	 * @param sql
	 * @param params
	 * @return An Object or null, Object type determined by SQL content
